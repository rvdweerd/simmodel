...
Thesis work-in-progress for UvA/AI MSc program
...
* Demo: escape agent traverses from Dam Square (Amstetrdam) to a target node, while avoiding pursuers that move to observation positions. Escape behavior is based on graph representation learning on smaller graphs, combined with reinforcement learning using PPO</br></br>
