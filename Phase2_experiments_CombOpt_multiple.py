...
from modules.rl.rl_policy import EpsilonGreedyPolicyDQN
...
#policy=EpsilonGreedyPolicyDQN(Q_net,env_all[0])
#policy.epsilon=0.
#EvaluatePolicy(env_all[0],policy,env_all[0].world_pool,logdir='results_Phase2/CombOpt2')
