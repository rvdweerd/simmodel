...
tmux send-keys -t subgr0 "python Phase2_generate_partial_graphs.py --num_edges 0 --U 3" Enter
#
...
tmux send-keys -t subgr1 "python Phase2_generate_partial_graphs.py --num_edges 1 --U 3" Enter
#
...
tmux send-keys -t subgr2 "python Phase2_generate_partial_graphs.py --num_edges 2 --U 3" Enter
#
...
tmux send-keys -t subgr3 "python Phase2_generate_partial_graphs.py --num_edges 3 --U 3" Enter
#
...
tmux send-keys -t subgr4 "python Phase2_generate_partial_graphs.py --num_edges 4 --U 3" Enter
#
...
tmux send-keys -t subgr5 "python Phase2_generate_partial_graphs.py --num_edges 5 --U 3" Enter
#
...
tmux send-keys -t subgr6 "python Phase2_generate_partial_graphs.py --num_edges 6 --U 3" Enter
#
#####################
###################
