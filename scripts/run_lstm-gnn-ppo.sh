...
tmux send-keys -t test2 "conda activate rlcourse-sb3c" Enter
tmux send-keys -t test2 "cd ~/testing/sim" Enter
tmux send-keys -t test2 "python Phase3_lstm-gnn-ppo.py --world_name " "$world" " --state_repr etUte0U0 --train True --eval False" Enter
