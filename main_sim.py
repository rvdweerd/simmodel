...
env=GraphWorld(conf, optimization_method='static', fixed_initial_positions=None)#((2,0),(4,4),(4,4),(4,4)))
...
EvaluatePolicy(env, policy,number_of_runs=1, print_runs=True, save_plots=True)