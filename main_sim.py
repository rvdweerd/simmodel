...
env=GraphWorld(conf, optimization_method='static', fixed_initial_positions=None, state_representation='et')#(5,114,115,116))#((0,1),(2,2)))#None)#((2,0),(3,4),(4,3),(4,4)))
...
#EvaluatePolicy(env, policy,[100,1000], print_runs=False, save_plots=True)
