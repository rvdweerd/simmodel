...
def Run_DQN_Experiment(args):
    ...
    for world_name in world_names:    
        ...
        exp_rootdir='./results/DQN_testing/'+world_name+'/'+env.state_representation+'/'
        # Load hyperparameters
        hp=GetHyperParams_DQN(world_name)
        dims_hidden_layers  = hp['dims_hidden_layers'][env.state_representation]
        batch_size          = hp['batch_size'][env.state_representation]
        mem_size            = hp['mem_size'][env.state_representation]
        discount_factor     = .9
        learn_rate          = hp['learning_rate'][env.state_representation]
        num_episodes        = hp['num_episodes'][env.state_representation]
        eps_0               = hp['eps_0'][env.state_representation]
        eps_min             = hp['eps_min'][env.state_representation]
        cutoff_factor       = hp['cutoff_factor'][env.state_representation]
