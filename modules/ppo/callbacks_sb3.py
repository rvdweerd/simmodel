...
class TestCallBack(BaseCallback):
    ...
    def _on_rollout_start(self) -> None:
        ...
        """
        res_det = evaluate_policy(self.model, self.training_env, n_eval_episodes=20, reward_threshold=-100, warn=False, return_episode_rewards=False, deterministic=True)
        print('Test result (deterministic): avg rew:', res_det[0], 'std:', res_det[1])
        res_nondet = evaluate_policy(self.model, self.training_env, n_eval_episodes=20, reward_threshold=-100, warn=False, return_episode_rewards=False, deterministic=False)
